		...
		for arm_vel in [0.2, 0.4]:
			for suc_rwd in [10.0, 100.0]:
				for pot_rwd in [1.0, 2.0]:
					...
					file_name = "pos_{}_tol_{}_suc_rwd_{}_pot_rwd_{}_gma_{}_lr_{}_nstps_{}_spd_{}_{}.yaml".format(pos,tol,suc_rwd,pot_rwd,gamma,lr,num_steps,wheel_vel,arm_vel)
					...
					f.write("collision_reward_weight: 0.0\n")
